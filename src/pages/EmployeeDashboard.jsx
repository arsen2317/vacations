...
function HRSummaryCard({ campaign, onGoToHR }) {
  return (
    <div className={`border rounded-2xl p-4 flex items-center gap-4 ${
      ...
      <button
        onClick={onGoToHR}
        className="shrink-0 px-3 py-1.5 bg-[#0066ff] hover:bg-[#0052cc] text-white text-xs font-medium rounded-lg transition-colors"
      >
        HR-панель
      </button>
    </div>
    ...
    <div className="max-w-5xl mx-auto px-4 py-6 space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-2 bg-[#0066ff] hover:bg-[#0052cc] text-white text-sm font-medium rounded-xl transition-colors"
        >
